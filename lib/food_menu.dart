...
var foodMenuList = [
  FoodMenu(
    ...
    imageUrls: ['https://www.resepmakansedap.com/images/nasi-goreng.jpg'],
  ),
  FoodMenu(
    name: 'Sate Ayam',
    category: 'Main Course',
  ...
  FoodMenu(
    ...
    ingredients: 'Daging sapi, santan, cabai, bawang merah, bawang putih, jahe, lengkuas',
  ...
  FoodMenu(
    name: 'Soto Ayam',
    category: 'Soup',
    description: 'Soto ayam dengan kuah kuning yang disajikan dengan lontong atau nasi.',
  ...
  FoodMenu(
    name: 'Mie Ayam',
    category: 'Main Course',
    description: 'Mie yang disajikan dengan potongan ayam berbumbu dan sayuran.',
  ...
  FoodMenu(
    name: 'Es Campur',
    category: 'Dessert',
    description: 'Minuman segar dengan berbagai campuran buah-buahan, agar-agar, dan sirup.',
  ...
  FoodMenu(
    name: 'Martabak Manis',
    category: 'Dessert',
    description: 'Martabak manis dengan berbagai topping seperti keju, cokelat, dan kacang.',
    ingredients: 'Tepung terigu, telur, gula, susu, mentega, topping (keju, cokelat, kacang)',
    cookingTime: '20 minutes',
    price: 'Rp 25000',
  ...
  FoodMenu(
    name: 'Klepon',
    category: 'Snack',
    description: 'Kue tradisional yang terbuat dari tepung ketan, berisi gula merah, dan dilapisi kelapa parut.',
  ...
  FoodMenu(
    name: 'Nasi Uduk',
    category: 'Main Course',
    description: 'Nasi yang dimasak dengan santan dan rempah-rempah, disajikan dengan lauk-pauk.',
  ...
  FoodMenu(
    ...
    ingredients: 'Daging sapi, santan, bawang merah, bawang putih, kemiri, jahe, lengkuas',
  ...
  FoodMenu(
    name: 'Pempek',
    category: 'Snack',
    description: 'Makanan khas Palembang yang terbuat dari ikan dan tepung sagu, disajikan dengan kuah cuko.',
    ingredients: 'Ikan tenggiri, tepung sagu, bawang putih, garam, gula merah, cuka',
    cookingTime: '30 minutes',
    price: 'Rp 20000',
  ...
  FoodMenu(
    name: 'Nasi Liwet',
    category: 'Main Course',
    description: 'Nasi yang dimasak dengan santan, disajikan dengan lauk pauk seperti ikan atau ayam.',
  ...
  FoodMenu(
    name: 'Martabak Telur',
    category: 'Snack',
    description: 'Martabak yang berisi campuran telur dan daging cincang, digoreng hingga garing.',
    ingredients: 'Tepung terigu, telur, daging cincang, daun bawang, bawang putih',
    cookingTime: '20 minutes',
    price: 'Rp 25000',
  ...
  FoodMenu(
    name: 'Es Cendol',
    category: 'Dessert',
    description: 'Minuman segar berisi cendol, santan, gula merah, dan es serut.',
  ...
  FoodMenu(
    name: 'Gulai Kambing',
    category: 'Main Course',
    description: 'Daging kambing yang dimasak dengan kuah santan dan rempah-rempah.',
    ingredients: 'Daging kambing, santan, bawang merah, bawang putih, jahe, lengkuas, cabai',
  ...
  FoodMenu(
    name: 'Kerak Telor',
    category: 'Snack',
    description: 'Makanan khas Betawi yang terbuat dari ketan dan telur, dimasak dengan bumbu kelapa dan ebi.',
